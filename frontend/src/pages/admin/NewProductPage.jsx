...
import {PRODUCT_CATEGORIES} from '../../components/helpers/categoryConstants'


import { useNewProductMutation } from "../../slices/prductApiSlice";
        ...
        <div className="row wrapper">
          <div className="col-10 col-lg-10 mt-5 mt-lg-0">
            <form className="shadow rounded bg-body" onSubmit={submitHandler}>
              <h2 className="mb-4">Nouveau Produit</h2>
              <div className="mb-3">
